...
public class SearchView extends View {
    ...
    private void initPath() {
        ...
        RectF oval1 = new RectF(-20, -20, 20, 20);          // 放大镜圆环
        path_srarch.addArc(oval1, 45, 359.9f);

        RectF oval2 = new RectF(-40, -40, 40, 40);      // 外部圆环
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int z = mViewHeight > mViewHeight ? mViewWidth : mViewHeight;
        mViewWidth = w;
        mViewHeight = h;
    }
